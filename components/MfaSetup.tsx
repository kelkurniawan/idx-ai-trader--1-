            ...
            {mfaEnabled ? (
                    ...
                    <div className="border-t border-slate-700 pt-4">
                        ...
                        <div className="flex gap-2">
                            <input
                                ...
                                className="flex-1 bg-slate-900 border border-slate-700 rounded-lg py-2 px-4 text-white text-center font-mono text-lg tracking-widest focus:ring-2 focus:ring-red-500 outline-none"
                                placeholder="000000"
                            />
                            <button
                                onClick={handleDisable}
                                disabled={loading}
                                className="px-4 bg-red-500/20 hover:bg-red-500/30 text-red-400 font-semibold rounded-lg transition-colors"
                            >
                                {loading ? '...' : 'Disable'}
                            </button>
                        </div>
                ...
                <div className="space-y-3">
                    ...
                    <button
                        ...
                        disabled={loading}
                        className="w-full p-4 bg-slate-700/30 hover:bg-slate-700/50 border border-slate-700 rounded-xl transition-all text-left flex items-center gap-4"
                    >
                        ...
                        <div>
                            <p className="font-semibold text-slate-200">Google Authenticator (TOTP)</p>
                            <p className="text-xs text-slate-400">Use an authenticator app to generate codes</p>
                        </div>
                    </button>
                    ...
                    >
                        ...
                        <div>
                            <p className="font-semibold text-slate-200">Email OTP</p>
                            <p className="text-xs text-slate-400">Receive a code via email at each login</p>
                        </div>
                    </button>
                    ...
                    <button
                        ...
                        className="w-full p-4 bg-slate-700/30 hover:bg-slate-700/50 border border-slate-700 rounded-xl transition-all text-left flex items-center gap-4 disabled:opacity-50 disabled:cursor-not-allowed"
                    >
                        ...
                        <div>
                            <p className="font-semibold text-slate-200">WhatsApp OTP</p>
                            <p className="text-xs text-slate-400">
